<?php
$image = rwmb_meta('image_background', ['object_type' => 'setting'], 'products');
$title = rwmb_meta('title', ['object_type' => 'setting'], 'products');
$mo_ta = rwmb_meta('mo_ta', ['object_type' => 'setting'], 'products');
